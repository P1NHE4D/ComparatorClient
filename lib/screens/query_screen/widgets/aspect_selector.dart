...
class AspectSelector extends StatefulWidget {
  @override
  _AspectSelectorState createState() => _AspectSelectorState();
}

class _AspectSelectorState extends State<AspectSelector> {
